...
impl FundingTxn {
    ...
    pub fn construct_trxn(&self) -> Result<Transaction, String> {
        ...
        let fees = FundingTxn::calculate_fees(tx_outputs, tx_inputs.clone(), input_total);
...
mod test {
    ...
    fn test_txn_fees() {
        ...
        let computed_fees = FundingTxn::calculate_fees(tx_outputs, inputs, input_total).unwrap();
